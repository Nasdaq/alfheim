...
<p>
  ...
  <a href="https://www.npmjs.com/package/@alfheim/cli">
    <img alt="npm (scoped with tag)" src="https://img.shields.io/npm/v/@alfheim/cli/latest">
  </a>
...
This is the primary package that should be installed to use the `@alfheim` library and its associated packages.
